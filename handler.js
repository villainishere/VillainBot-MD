...
export async function handler(chatUpdate) {
    ...
    global.img = 'https://telegra.ph/file/49d64cb0a9a6cd0802116.png' 
                ...
                for (let user of participants) {
                    ...
                    try {
                        ...
                        let wel = API('zeltoria', '/api/maker/welcome', {
                                ...
                                pp: pp,
                                bg: 'https://telegra.ph/file/e7f09d6324bd9109184b4.png'
                            }, 'apikey')
...
let fkon = { key: { fromMe: false, participant: `${m.sender.split`@`[0]}@s.whatsapp.net`, ...(m.chat ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { contactMessage: { displayName: `${name}`, vcard: `BEGIN:VCARD\nVERSION:3.0\nN:;a,;;;\nFN:${name}\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`}}}
  let nyaww = 'https://telegra.ph/file/8a7166fa056ebc0448a24.png'
  let fotodaftar = 'https://telegra.ph/file/8a7166fa056ebc0448a24.png'
let msg = {
  ...
  let daftar = {
  unreg: 'Sebelum Menggunakan Fiturku, Kamu Harus Daftar Ke Database Terlebih Dahulu\nCaranya Ketik .daftar namakamu.umurkamu\nContoh : .daftar guchangge.25'}[type]
